...
export const VolatilityChart: React.FC<VolatilityChartProps> = ({
    ...
    const chartData = React.useMemo(() => {
        ...
        return mockData.map((point, index) => ({
            ...
            parkinson_volatility: metrics.parkinson_volatility || (0.025 + Math.sin(index * 0.06) * 0.008 + Math.random() * 0.003),
            garman_klass_volatility: metrics.garman_klass_volatility || (0.022 + Math.sin(index * 0.07) * 0.007 + Math.random() * 0.004),
            // Volatility percentile and regime
            volatility_percentile: metrics.volatility_percentile || (50 + Math.sin(index * 0.05) * 20 + Math.random() * 10),
    ...
    return (
        <ChartContainer
            ...
            badges={[
                { 
                    label: currentRegime, 
                    variant: currentRegime === "LOW" ? "success" : 
                            currentRegime === "MODERATE" ? "warning" : "destructive" 
                },
